                                ...
                                <div class="book-ur-car">
                                    <form action="index2.html">
                                        ...
                                        <button type="submit"><B></B></button>
                                                <a href="index1.php" class="btn btn-warning btn-lg active" role="button" aria-pressed="true"><b>Search</b></a>
                                ...
                                ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 con suv mpv">
                                        <div class="single-popular-car">
                                            ...
                                            <br><a href="bill.php?car_regis=<?php echo $row['car_regis']; ?>&id=<?php echo $row['car_id']; ?>" class="rent-btn">Book It</a>
