...
$numrand = (mt_rand());
    ...
    $img = $new_image_name;
        ...
        $user_check ="SELECT * FROM c_member WHERE 
        ...
        if ($row['username'] === $username){
            ...
            // if username have 1 will insert into member
            
            $query = "INSERT INTO c_member (firstname, email, username, password, phone,img, userlevel)
                        VALUE('" . $firstname . "', '" . $email . "', '" . $username . "', '" . $password . "','" . $phone . "','" . $img . "', '" . "$member" . "')";
                	...
                	<div class="login-page-content">
                		<div class="login-form">
							...
							<form action="register.php" method="POST" enctype="multipart/form-data" >
                                ...
                                <P ALIGN = "LEFT" > <b>อัพโหลดรูปใบขับขี่/พาสปอร์ต </b></P>
								...
								<div class="log-btn text-center ">
									<button type="submit" name="submit"id="submit" ><i class="fa fa-check-square"></i> Sign Up</button>
								</div>
							</form>
                		</div>
